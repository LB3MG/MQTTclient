...
/*
 * ESP8266 code for Sonoff relay.
 * Maintained by lb3mg@radiokameratene.no
 * 
 * It connects to an MQTT server then:
 * on 0 switches off relay
 * on 1 switches on relay
 * on 2 switches the state of the relay
 * publishes 0 once on outTopic when off
 * publishes 1 once on outTopic when on
 * 
 ...
 * Thanks to rutierut on the esp8266.com forum for the examples.
*/
...
// Network setup
const char* ssid = "Link";              //Your APs SSID
const char* password = "abcd1234";      //The password for it
const char* mqtt_server = "10.0.0.11";  //The IP of your broker
...
// Topics for MQTT
const char* outTopic = "espout"; //publish
const char* inTopic = "espin"; //subscribe

int relay_pin = 12; //12 on sonoff maybe
int button_pin = 0; //The button on the Sonoff is on GPIO 0
bool relayState = LOW; //State on boot
